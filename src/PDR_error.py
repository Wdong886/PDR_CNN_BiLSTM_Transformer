...
DATA_PATH = 'D:/博士/IMU定位/DeadReckoning-main/data/'
GRAPH_PATH = 'D:/博士/IMU定位/DeadReckoning-main/graphs/'
...
if __name__ == "__main__":
    ...
    # 保存到新的Excel文件
    modified_data.to_excel(DATA_PATH + 'zhicheng_leg2_data_with_errors.xls', index=False)
