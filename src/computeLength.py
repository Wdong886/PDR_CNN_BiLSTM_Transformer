...
DATA_PATH = r'D:\博士\IMU定位\final\PersonDeadReckoning\data/'
GRAPH_PATH = r'D:\博士\IMU定位\final\PersonDeadReckoning\graphs/'
...
def computeStepLength(data, timestamps, cst):
    ...
    for i in range(steps):
        ...
        # 记录该步完成时的时间戳
        print(timestamps[np.where(timestamps == end)][0])
