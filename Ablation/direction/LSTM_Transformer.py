...
from tensorflow.keras.layers import Input, Bidirectional, LSTM, MultiHeadAttention, Add, LayerNormalization, Dense, GlobalAveragePooling1D
...
# ===================== 模型构建：双向 LSTM + Transformer =====================
def build_model_biLSTM_transformer(input_shape):
...
model = build_model_biLSTM_transformer(input_shape)
...
print(f"LSTM_Transformer: 验证集 MSE: {mse:.4f}, MAE: {mae:.4f}, R²: {r2:.4f}")
