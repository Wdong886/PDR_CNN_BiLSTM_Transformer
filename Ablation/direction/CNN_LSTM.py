...
from tensorflow.keras.layers import Input, Conv1D, BatchNormalization, MaxPooling1D, Dropout, Dense, Bidirectional, LSTM
...
model = build_model_cnn_bilstm(input_shape)
...
print(f"CNN + BiLSTM: 验证集 MSE: {mse:.4f}, MAE: {mae:.4f}, R²: {r2:.4f}")
